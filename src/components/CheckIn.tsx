    ...
    <div className="pt-5">
      <div>
        ...
        <p className="text-xl text-gray-600 font-medium text-center">
          Rent a convenient parking space for affordable prices
        </p>
      </div>
      <form
        className="my-5 p-10 text-lg border-[#ccc] border rounded-lg bg-[#f5f5f5] flex flex-wrap justify-around"
        onSubmit={handleSubmit}
      >
        <div className="mb-5 mx-2 w-1/3">
          <label className="font-semibold" htmlFor="durationType">
            Duration Type:
          </label>
          <select
            id="durationType"
        ...
        <div className="mb-5 mx-2 w-1/3">
          <label className="font-semibold" htmlFor="duration">
            Duration: ({durationType === DurationType.HOURLY ? "hours" : "days"}
            )
          </label>
          <input
            type="number"
        ...
        <div className="w-full text-center">
          <input
            type="submit"
            value={`${loading ? "Loading..." : "Check In"}`}
