        ...
        <div className='text-center mt-12'>
            ...
            <form className='my-10 p-10 text-lg border-[#ccc] border rounded-lg bg-[#f5f5f5] flex flex-wrap justify-around'>
                ...
                <div className='mb-5 mx-2 w-1/3'>
                    ...
                    <input type="text" id="parkingLotName" name="parkingLotName" placeholder="Enter parking lot name" className='input w-full' />
                </div>
                <div className='mb-5 mx-2 w-1/3'>
                    <label className='font-semibold' htmlFor="address">Address:</label>
                    <input type="text" id="address" name="address" placeholder="Enter address" className='input w-full' />
                </div>
                <div className='mb-5 mx-2 w-1/3'>
                    <label className='font-semibold' htmlFor="city">City/State:</label>
                    <input type="text" id="city" name="city" placeholder="Enter city" className='input w-full' />
                </div>
                <div className='mb-5 mx-2 w-1/3'>
                    <label className='font-semibold' htmlFor="hourly">Hourly Price:</label>
                    <input type="number" id="hourly" name="hourly" placeholder="Enter hourly price" className='input w-full' />
                </div>
                <div className='mb-5 mx-2 w-1/3'>
                    <label className='font-semibold' htmlFor="daily">Daily Price:</label>
                    <input type="number" id="daily" name="daily" placeholder="Enter daily price" className='input w-full' />
                </div>
                ...
                <div className='w-full text-center'>
                    <input type="submit" value="Add Parking Space" className='mt-5 bg-green-500 hover:bg-green-600 text-white px-5 py-2 rounded' />
                </div>
            </form>
        </div>
    )
